                ...
                <div className={this.state.class} >
                    ...
                    <div className="projectCardFace projectBack">
                        ...
                        <div className="linkDiv">
                            <a href={this.props.gitlink} target="_blank"><img src={githubIcon} className="linkTo" /></a>
                            <a href={this.props.demolink} target="_blank"><img src={externalIcon} className="linkTo"/></a>
                        </div>
                    </div>
                </div>
            </div>
